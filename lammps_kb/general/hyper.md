...
id: hyper
title: "hyper command"
url: https://docs.lammps.org/hyper.html
---
...
dynamics methods (AMD) for such systems in given in (Voter2002) from the same group.  To quote from the review paper:
...
occur.  See the prd page for more info about PRD.
...
- [fix hyper/global](fix_hyper_global.html)
