...
id: if
title: "if command"
url: https://docs.lammps.org/if.html
---
...
The Commands parse page has more details on
...
like an equal-style variable, or it can produce a
string, like an index-style variable.
