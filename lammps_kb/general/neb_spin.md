---
id: neb_spin
title: "neb/spin command"
url: https://docs.lammps.org/neb_spin.html
---
...
GNEB spins involved (see equation (13) in (Bessarab)).
...
(Bessarab).  As before, the other replicas rearrange
...
of (Bessarab)), between a replica i and the next replica
...
- [min/spin](min_spin.html)
- [fix neb/spin](fix_neb_spin.html)
