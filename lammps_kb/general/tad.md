...
id: tad
title: "tad command"
url: https://docs.lammps.org/tad.html
---
...
TAD is described in this paper by Art Voter.  It is
...
this review paper from the same group.  To quote
...
criterion is that the confidence measure be greater than 1-delta. The confidence measure is the probability that no earlier
...
- [compute event/displace](compute_event_displace.html)
