---
id: change_box
title: "change_box command"
url: https://docs.lammps.org/change_box.html
---
...
See the Howto triclinic page for a
...
command are now handled according to the thermo_modify lost setting, the same policy used to detect lost atoms during a
...
write_data command to write a corrupted data file).
...
re-balance the atoms by using the balance command
if that is the case.
