---
id: replicate
title: "replicate command"
url: https://docs.lammps.org/replicate.html
---
...
processors command.  The partitioning can be
changed by subsequent balance or fix balance commands.
...
positions of nearby atoms, e.g. models using the AIREBO or ReaxFF potentials.
...
replication and then deleted via the unfix command and
