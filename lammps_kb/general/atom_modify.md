---
id: atom_modify
title: "atom_modify command"
url: https://docs.lammps.org/atom_modify.html
---
...
Note
If a triclinic simulation box is used,
...
The first keyword allows a group to be specified
...
neigh_modify include and comm_modify group commands are two examples of commands that require this
setting to work efficiently.  Several fixes, most notably
time integration fixes like fix nve, also take
...
numbers (e.g. velocity create, and fix
langevin), may generate (statistically identical)
results which depend on the order in which atoms are processed.
The order of atoms in a dump file will also typically
