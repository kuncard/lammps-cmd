---
id: temper
title: "temper command"
url: https://docs.lammps.org/temper.html
---
...
partitions are defined at run-time using the -partition
command-line switch.  Note that if you have MPI
...
to N-1, with N = # of replicas.  See the -log and -screen
command-line switches for info on how to change these
names.
...
assignments for the Nth replica by comparing the Nth column of
