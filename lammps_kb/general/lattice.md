---
id: lattice
title: "lattice command"
url: https://docs.lammps.org/lattice.html
---
...
orthogonal or restricted triclinic box.  The Howto triclinic doc page explains all 3 kinds of simulation boxes
LAMMPS supports.
...
The create_box command can be used to create a
...
Likewise, the create_atoms command can be used
...
defined by the create_box and
create_atoms commands are converted from
