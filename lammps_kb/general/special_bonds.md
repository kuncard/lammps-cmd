---
id: special_bonds
title: "special_bonds command"
url: https://docs.lammps.org/special_bonds.html
---
...
factors are used by nearly all pair styles in
...
file read by the read_data command.  Typically a
...
elsewhere in your system, e.g. when using the pair_style
hybrid command.  Thus LAMMPS ignores special_bonds
...
kspace style and pair styles amoeba, hippo, thole,
coul/exclude, and pair styles that include
...
some pair styles, such as pair_style amoeba and
pair_style hippo.
