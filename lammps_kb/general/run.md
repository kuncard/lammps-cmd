...
are adding a fix or dump or
compute, changing a neighbor
list parameter, using the set command, or writing a
restart file via the write_restart command,
...
Howto couple page for ideas about how to
