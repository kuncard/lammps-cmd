---
id: create_bonds
title: "create_bonds command"
url: https://docs.lammps.org/create_bonds.html
---
...
impropers) are added to an atom.  If the read_data
...
keywords to the command.  If the create_box
...
the current bond topology, then you need to use special_bonds
lj 0 1 1 to ensure those pairs appear in the
...
file read by the read_data command (i.e., the three atoms
...
For style many, no kspace style must be
