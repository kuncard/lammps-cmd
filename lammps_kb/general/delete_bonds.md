---
id: delete_bonds
title: "delete_bonds command"
url: https://docs.lammps.org/delete_bonds.html
---
...
type label.  Otherwise, the type should be an
...
Note that the fix shake command also sets bond and angle
...
fix shake command to fail due to an atom s bonds being
