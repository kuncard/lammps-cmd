...
id: neb
title: "neb command"
url: https://docs.lammps.org/neb.html
---
...
fix neb command, which must be used in conjunction
...
supported compression format suffix).  The file can
