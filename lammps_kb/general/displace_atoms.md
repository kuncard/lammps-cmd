---
id: displace_atoms
title: "displace_atoms command"
url: https://docs.lammps.org/displace_atoms.html
---
...
units command (e.g., \(\AA\) for
real or metal units). Lattice means distance units are in lattice
spacings.  The lattice command must have been previously used
