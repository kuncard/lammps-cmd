---
id: geturl
title: "geturl command"
url: https://docs.lammps.org/geturl.html
---
...
the libcurl library which supports a
...
The libcurl library supports routing
traffic through proxies by setting
...
if LAMMPS was built with that package.  See the Build package page for more info.  It also requires that LAMMPS was
built with support for the libcurl library.  See the page about Compiling LAMMPS
