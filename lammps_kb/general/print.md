...
id: print
title: "print command"
url: https://docs.lammps.org/print.html
---
...
See the variable command for a description of
...
values calculated by a compute or fix,
or references to other variables.  Vector-style
...
syntax as equal-style variables described on the variable doc page.  This is a convenient way to evaluate a
...
This is also explained on the Commands parse doc page.
