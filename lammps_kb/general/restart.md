...
url: https://docs.lammps.org/restart.html
---
...
Enabling or disabling restarts may change the trajectory
...
regardless of the neigh_modify every,
...
neigh_modify with check set to no and
