...
id: group
title: "group command"
url: https://docs.lammps.org/group.html
---
...
variable page for more details on ensuring that
...
property/atom command.  This means the values in
the vector can be read as part of a data file with the read_data command or specified with the set command.  Or
accessed and changed via the library interface to LAMMPS, or by styles you add to LAMMPS (pair, fix, compute,
...
Also when selecting atoms for output to a dump file it is
