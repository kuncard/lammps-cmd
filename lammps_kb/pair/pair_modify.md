---
id: pair_modify
title: "pair_modify command"
url: https://docs.lammps.org/pair_modify.html
---
...
pair_coeff command or in the  Pair Coeffs  or  PairIJ Coeffs 
sections of the data file.  For some pair styles it is not
...
restrictions when using pair style hybrid or hybrid/overlay.  See the page for individual pair styles for those
restrictions.  Note also that the pair_coeff command
...
using pair hybrid/overlay.  When this keyword is
...
cutoffs for different pairs for atoms type, the neighbor style
multi should be used to create optimized neighbor lists.
...
- [compute */tally](compute_tally.html)
- [neighbor multi](neighbor.html)
