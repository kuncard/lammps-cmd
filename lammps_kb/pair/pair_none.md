---
id: pair_none
title: "pair_style none command"
url: https://docs.lammps.org/pair_none.html
---
...
neighbor command and the comm_modify command).  When you have bonds, angles, dihedrals, or
...
However if the neighbor style is bin, data
...
See the pair_style zero for a way to set a pairwise
...
Restrictions 
You must not use a pair_coeff command with this pair
style.  Since there is no interaction computed, you cannot set any
coefficients for it.

## Related Commands

- [pair_style zero](pair_zero.html)
