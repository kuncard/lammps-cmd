---
id: pair_e3b
title: "pair_style e3b command"
url: https://docs.lammps.org/pair_e3b.html
---
...
water model, through pair style hybrid/overlay.  The
...
K2.  See (Kumar 2008) for more details.
...
the values used in (Tainter 2011) or
(Tainter 2015).  To use the water models defined in
...
should be used with the TIP4P water model.  The
preset 2015 option should be used with the TIP4P/2005 water
model.  If the preset keyword is used, no other keyword
...
into sub-categories, which can be accessed via the compute pair command as a vector of values of length 4.  The 4 values
