---
id: pair_tersoff_mod
title: "pair_style tersoff/mod command"
url: https://docs.lammps.org/pair_tersoff_mod.html
---
...
\[\begin{split}V_{ij} = f_C(r_{ij} + \delta) \left[ f_R(r_{ij} + \delta) + b_{ij} f_A(r_{ij} + \delta) + c_0 \right] \\\end{split}\]
...
More information on this option is given on the main pair_tersoff page.
