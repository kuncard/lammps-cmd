---
id: pair_table
title: "pair_style table command"
url: https://docs.lammps.org/pair_table.html
---
...
short-range pair styles, such as pair_style lj/cut/coul/long.  Note that it is up to you to ensure
...
be created by LAMMPS itself using the pair_write
command.  In combination with the pair styles python,
lepton, or lepton/coul this can be a powerful
