---
id: pair_kim
title: "pair_style kim command"
url: https://docs.lammps.org/pair_kim.html
---
...
OpenKIM is the kim command interface. That
...
used by the kim command interface as needed.
...
this is the extended KIM ID (see kim command
