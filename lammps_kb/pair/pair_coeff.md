---
id: pair_coeff
title: "pair_coeff command"
url: https://docs.lammps.org/pair_coeff.html
---
...
alphanumeric string defined by the labelmap command
or in a section of a data file read by the read_data command, and which converts internally to a numeric type.
...
later identified.  The UNITS: tag indicates the units
