...
The sw style computes a 3-body Stillinger-Weber
...
\[\begin{split}f_C(\delta) & = \left\{ \begin{array} {r@{\quad:\quad}l}
...
but not available for the sw/mod and sw/angle/table pair style variants.  To turn off the threebody
...
by the first pair_coeff command and the element
