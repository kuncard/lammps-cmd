---
id: pair_tersoff_zbl
title: "pair_style tersoff/zbl command"
url: https://docs.lammps.org/pair_tersoff_zbl.html
---
...
information on this option is given on the main pair_tersoff page.
...
directory) are parameterized for  metal  units.  Also the
