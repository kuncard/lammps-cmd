---
id: pair_sw_angle_table
title: "pair_style sw/angle/table command"
url: https://docs.lammps.org/pair_sw_angle_table.html
---
...
See the pair_coeff page for alternate ways to
...
potential has to be of the format as used in the angle_style table command:
...
shake command. If not used, the equilibrium angle is set to
180.0.
...
- [pair_style sw](pair_sw.html)
- [pair_style threebody/table](pair_threebody_table.html)
