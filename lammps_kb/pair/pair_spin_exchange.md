---
id: pair_spin_exchange
title: "pair_style spin/exchange command"
url: https://docs.lammps.org/pair_spin_exchange.html
---
...
file or restart files read by the read_data or
read_restart commands, and set in the following order:
