---
id: pair_tersoff
title: "pair_style tersoff command"
...
in Tersoff_2 (Tersoff_2) is ambiguous on this point,
...
and third elements. Albe et al. adopts the same convention.
...
directory) are parameterized for  metal  units.  In addition
