...
materials using the modified embedded-atom method (MEAM) (Baskes).  Conceptually, it is an extension to the original EAM
method which adds angular forces.  It is thus suitable for
