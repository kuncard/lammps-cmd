---
id: pair_eim
title: "pair_style eim command"
url: https://docs.lammps.org/pair_eim.html
---
...
atoms, where \(\phi_{ij}\) is a pair potential.  The second term
sums over the embedding energy \(E_i\) of atom I, which is a
function of its charge \(q_i\) and the electrical potential
\(\sigma_i\) at its location.  \(E_i\), \(q_i\), and
\(\sigma_i\) are calculated as
...
f_{c}\left(r,r_p,r_c\right) = & 0.510204 \cdot \mathrm{erfc}\left[\frac{1.64498\left(2r-r_p-r_c\right)}{r_c-r_p}\right] - 0.010204\end{split}\]
