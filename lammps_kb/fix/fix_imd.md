---
id: fix_imd
title: "fix imd command"
url: https://docs.lammps.org/fix_imd.html
---
...
visualization program (currently only supports IMDv2) or the
Python IMDClient (supports both IMDv2 and IMDv3), so
...
-DLAMMPS_ASYNC_IMD then fix imd will use POSIX threads to
...
allows codes like LAMMPS to hook to VMD.
...
In IMDv3, the IMD protocol has been extended to allow for
...
objects. See the VMD IMD Homepage for more details.
