---
id: fix_atom_swap
title: "fix atom/swap command"
url: https://docs.lammps.org/fix_atom_swap.html
---
...
time integration displacements (e.g., via fix nvt),
...
performing GCMC moves), you must enable the fix_modify energy option for that fix.  The doc pages for
...
When this fix is used with a hybrid pair style
