---
id: fix_hyper_local
title: "fix hyper/local command"
url: https://docs.lammps.org/fix_hyper_local.html
---
...
fix hyper/global page for details.
...
\(t_{hyper}\) for an LHD simulation running for N timesteps is simply
...
time (\(t_{hyper}\) equation above) will be shorter.
