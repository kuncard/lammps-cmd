---
id: fix_langevin
title: "fix langevin command"
url: https://docs.lammps.org/fix_langevin.html
---
...
Apply a Langevin thermostat as described in (Bruenger)
...
compute temp/sphere and compute
temp/asphere commands with their rotate
options.
...
functionality has been moved to its own fix style fix gjf. and it is strongly recommended to use that fix instead.
