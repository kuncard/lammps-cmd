---
id: fix_shake
title: "fix shake command"
url: https://docs.lammps.org/fix_shake.html
---
...
(e.g. fix efield) that add additional forces to
...
deposit or fix pour, add molecules
...
timestep.  Even though the restraints will not
...
units setting and is 1.0e9*k_B.
...
During an MD run, the constraint forces are the forces on
...
During a minimization, restraint forces are added to
...
rigid/small instead to simulate rigid linear molecules.
