---
id: fix_wall_gran
title: "fix wall/gran command"
url: https://docs.lammps.org/fix_wall_gran.html
---
...
pair_style granular are not taken into consideration. To
...
Note
As discussed on the page for pair_style gran/*,
...
pair_style granular page is the mass of the particle
...
fix rigid command (or its variants).
...
Deprecated since version 11Feb2026.

The zcylinder wallstyle has been removed.  Pleas use fix
wall/gran/region instead.
...
- [fix move](fix_move.html)
- [fix wall/gran/region](fix_wall_gran_region.html)
- [pair_style gran/*](pair_gran.html)
- [pair_style granular](pair_granular.html)
