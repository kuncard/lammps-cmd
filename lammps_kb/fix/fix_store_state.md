---
id: fix_store_state
title: "fix store/state command"
url: https://docs.lammps.org/fix_store_state.html
---
...
dump custom command, which describes their meaning.
...
argument must be a variable reference to an
