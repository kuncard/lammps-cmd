---
id: fix_electron_stopping
title: "fix electron/stopping command"
url: https://docs.lammps.org/fix_electron_stopping.html
---
...
publications, experimental databases or by using SRIM
software. Other programs such as CasP can calculate the
