---
id: fix_print
title: "fix print command"
url: https://docs.lammps.org/fix_print.html
---
...
variable, which should be specified as v_name, where name
...
logfreq() and stride() math functions for equal-style variables, as examples of useful functions to use in this
