---
id: fix_langevin_spin
title: "fix langevin/spin command"
url: https://docs.lammps.org/fix_langevin_spin.html
---
...
Apply a Langevin thermostat as described in (Mayergoyz) to the
...
only enabled if LAMMPS was built with this package.  See the Build package page for more info.
...
- [fix nve/spin](fix_nve_spin.html)
- [fix precession/spin](fix_precession_spin.html)
