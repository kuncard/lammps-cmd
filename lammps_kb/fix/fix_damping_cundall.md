---
id: fix_damping_cundall
title: "fix damping/cundall command"
url: https://docs.lammps.org/fix_damping_cundall.html
---
...
following the model of Cundall, 1987, as implemented in other
granular physics code (e.g., Yade-DEM, PFC).
...
e.g., by fix addforce or fix
addtorque/group will not be damped. When
performing simulations with gravity, invoking fix gravity after this fix will maintain the specified
