---
id: fix_charge_regulation
title: "fix charge/regulation command"
url: https://docs.lammps.org/fix_charge_regulation.html
---
...
page for more info.
The atom_style, used must contain the charge
...
can be easily achieved using the pair_modify
