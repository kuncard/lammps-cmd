---
id: fix_deposit
title: "fix deposit command"
url: https://docs.lammps.org/fix_deposit.html
---
...
particles, you will want to use the compute_modify dynamic/dof yes option, which ensures the current number of atoms is
...
keyword is the name of an equal-style variable that
...
must be internal-style variables specified by the
...
the compute_modify dynamic/dof yes command
