---
id: fix_rx
title: "fix rx command"
url: https://docs.lammps.org/fix_rx.html
---
...
property/atom fixes. Each species in a
...
- [fix eos/table/rx](fix_eos_table_rx.html)
- [fix shardlow](fix_shardlow.html)
- [pair dpd/fdt/energy](pair_dpd_fdt.html)
