---
id: fix_meso_move
title: "fix meso/move command"
url: https://docs.lammps.org/fix_meso_move.html
---
...
other fixes (e.g. fix sph, fix
sph/stationary), since that will change their
...
fix sph command).  It is up to you to decide
...
the same as the fix sph command would perform, using
...
the fix sph command would perform, using the
...
component is time integrated the same as the fix sph
