---
id: fix_settorque_atom
title: "fix settorque/atom command"
url: https://docs.lammps.org/fix_settorque_atom.html
---
...
addtorque/group, it does not set a collective
...
also be accomplished using fix freeze.
...
as an equal-style or atom-style variable, namely tx,
...
fix setforce to simultaneously zero forces and
