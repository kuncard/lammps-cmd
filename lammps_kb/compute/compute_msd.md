---
id: compute_msd
title: "compute msd command"
url: https://docs.lammps.org/compute_msd.html
---
...
image flags associated with each atom.  See the dump custom command for a discussion of  unwrapped  coordinates.  See the
Atoms section of the read_data command for a
...
for example, fix deposit or
fix evaporate.

## Related Commands

- [compute msd/nongauss](compute_msd_nongauss.html)
- [compute displace_atom](compute_displace_atom.html)
- [fix store/state](fix_store_state.html)
- [compute msd/chunk](compute_msd_chunk.html)
