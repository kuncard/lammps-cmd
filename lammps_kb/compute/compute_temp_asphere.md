---
id: compute_temp_asphere
title: "compute temp/asphere command"
url: https://docs.lammps.org/compute_temp_asphere.html
---
...
compute_modify extra/dof command to adjust
the DOF accordingly.
...
The latter is the case for uniaxial ellipsoids in a GayBerne model since there is no induced torque around the optical
...
the compute temp command.  The rotational kinetic
...
as defined by the atom_style ellipsoid command.
