---
id: compute_vacf_chunk
title: "compute vacf/chunk command"
url: https://docs.lammps.org/compute_vacf_chunk.html
---
...
use the ids once option when specifying the compute
chunk/atom command.  Note that if this is not
...
- [compute vacf](compute_vacf.html)
