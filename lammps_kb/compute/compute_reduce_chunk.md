---
id: compute_reduce_chunk
title: "compute reduce/chunk command"
url: https://docs.lammps.org/compute_reduce_chunk.html
---
...
used in conjunction with the compute chunk/spread/atom command it can be used to create per-atom
values that induce a new set of chunks with a second compute
...
evaluation of an atom-style variable.
...
specify multiple values.  This takes the form  *  or  *n  or  m*  or
 m*n .  If \(N\) is the size of the vector (for mode = scalar) or
...
- [compute chunk/spread/atom](compute_chunk_spread_atom.html)
