---
id: compute_temp_cs
title: "compute temp/cs command"
url: https://docs.lammps.org/compute_temp_cs.html
---
...
core/shell model of (Mitchell and Fincham).
See the Howto coreshell page for an overview of
...
fix_modify (e.g., fix temp/rescale, fix npt).
...
compute pressue command.  The formula for the
...
Thermostatting fixes that work in this way include fix nvt, fix temp/rescale, fix
...
defined as core/shell pairs.  See the Howto coreshell doc page for more discussion on how to do this.
...
- [compute temp/chunk](compute_temp_chunk.html)
