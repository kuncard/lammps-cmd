---
id: compute_property_grid
title: "compute property/grid command"
url: https://docs.lammps.org/compute_property_grid.html
---
...
Howto grid doc page for details of how distributed
...
so they can be accessed by other output commands
such as dump grid.

Nx, Ny, and Nz define the size of the grid.  For a 2d simulation
Nz must be 1.  When this compute is used by dump grid,
...
For triclinic simulation boxes, the grid
