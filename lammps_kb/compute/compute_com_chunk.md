---
id: compute_com_chunk
title: "compute com/chunk command"
url: https://docs.lammps.org/compute_com_chunk.html
---
...
This compute calculates the \((x,y,z)\) coordinates of the center of
...
atom.  See the dump custom command for a discussion of
...
reset_atoms image or set image
commands.
