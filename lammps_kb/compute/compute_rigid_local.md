---
id: compute_rigid_local
title: "compute rigid/local command"
url: https://docs.lammps.org/compute_rigid_local.html
---
...
directly from the fix as global data; see the fix rigid page for details
...
mass (COM) of the body.  The x, y, z attributes write the COM
 unscaled , in the appropriate distance units
(\(\AA\), \(\sigma\), etc).  Use xu, yu, zu if you want the COM  unwrapped  by
