---
id: compute_group_group
title: "compute group/group command"
url: https://docs.lammps.org/compute_group_group.html
---
...
the default setting for the special_bonds command,
...
numbers that are not exactly zero (e.g., \(1.0 \times 10^{-50}\)).
Another workaround would be to write a dump file and use the
rerun command to compute the group/group interactions for
snapshots in the dump file. The rerun script can use a
special_bonds command that includes all pairs in the
neighbor list.
