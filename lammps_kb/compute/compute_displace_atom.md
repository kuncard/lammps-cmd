---
id: compute_displace_atom
title: "compute displace/atom command"
url: https://docs.lammps.org/compute_displace_atom.html
---
...
image flags associated with each atom.  See the dump custom command for a discussion of  unwrapped  coordinates.  See
the Atoms section of the read_data command for a
...
by using the set image command.
...
atoms that have displaced more than \(0.6~\AA\) on each
...
atom-style variable which calculates a Boolean value (0 or 1)
