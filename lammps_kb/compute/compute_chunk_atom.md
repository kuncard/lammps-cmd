---
id: compute_chunk_atom
title: "compute chunk/atom command"
url: https://docs.lammps.org/compute_chunk_atom.html
---
...
See the Howto chunk page for an overview of how
...
tilted faces of the simulation box.  See the Howto triclinic page for a discussion of the
...
units command (e.g., \(\AA\) for units = real or metal).
...
- [compute global/atom](compute_global_atom.html)
