---
id: compute_voronoi_atom
title: "compute voronoi/atom command"
url: https://docs.lammps.org/compute_voronoi_atom.html
---
...
input.  See the Howto output page for an
...
Voro++ package, written by Chris Rycroft at UC Berkeley and LBL,
...
processor is determined by the cutoff used for pair_style interactions.  The cutoff can be set explicitly via
the comm_modify cutoff command.  The Voronoi
...
simulation box for 2d simulations when using the create_box or read_data commands.
