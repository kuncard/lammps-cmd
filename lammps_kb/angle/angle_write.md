---
id: angle_write
title: "angle_write command"
url: https://docs.lammps.org/angle_write.html
---
...
atype, using the appropriate angle_coeff
...
angle_style table option with keyword as the
...
current date and units settings.  For subsequent
...
This condition excludes for example angle style hybrid and
angle style table.
...
angle style class2 all angle types for
angle style charmm that have non-zero
...
- [dihedral_write](dihedral_write.html)
