---
id: angle_amoeba
title: "angle_style amoeba command"
url: https://docs.lammps.org/angle_amoeba.html
---
...
E_{UB} & = K_{ub} (r_{ik} - r_{ub})^2\end{split}\]
...
For the \(E_{ub}\) formula, each line in a angle_coeff command in the input script lists 3 coefficients, the
...
package.  See the Build package doc page for
more info.
