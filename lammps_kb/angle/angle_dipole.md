---
id: angle_dipole
title: "angle_style dipole command"
url: https://docs.lammps.org/angle_dipole.html
---
...
\[\begin{split}-\vec{T}_j & = \vec{r}_{ij} \times \vec{F}_i \\
\vec{F}_j  & = -\vec{F}_i\end{split}\]
...
DIPOLE package.  See the Build package doc
page for more info.
...
- [angle_hybrid](angle_hybrid.html)
