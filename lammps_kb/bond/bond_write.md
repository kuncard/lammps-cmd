---
id: bond_write
title: "bond_write command"
url: https://docs.lammps.org/bond_write.html
---
...
the currently defined bond style for a selected bond
...
the appropriate bond_coeff coefficients. N evenly
...
table option with keyword as the section name.  Each
...
with a  DATE:  and  UNITS:  tag with the current date and units settings.  For subsequent invocations of the bond_write
