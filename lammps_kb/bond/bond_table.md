---
id: bond_table
title: "bond_style table command"
url: https://docs.lammps.org/bond_table.html
---
...
itself from existing bond styles using the bond_write command.  This can be useful to have a template file for
...
shake command.  If not used, the equilibrium bond length is
