---
id: bond_harmonic_shift_cut
title: "bond_style harmonic/shift/cut command"
url: https://docs.lammps.org/bond_harmonic_shift_cut.html
---
...
harmonic for \(r <= r_c\), can be computed using
...
- [bond_style harmonic/shift](bond_harmonic_shift.html)
