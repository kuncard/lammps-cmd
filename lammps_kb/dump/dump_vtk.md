---
id: dump_vtk
title: "dump vtk command"
url: https://docs.lammps.org/dump_vtk.html
---
...
timesteps in a format readable by the VTK visualization toolkit or other visualization tools that use it, such
as ParaView.  The time steps on which dump
...
is the same as for the dump_style custom command; see its
