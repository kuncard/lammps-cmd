---
id: dihedral_write
title: "dihedral_write command"
url: https://docs.lammps.org/dihedral_write.html
---
...
be used as input for use with dihedral style table.
...
dtype, using the appropriate dihedral_coeff
...
dihedral_style table option with keyword as
...
the current date and units settings.  For subsequent
...
This condition excludes for example dihedral style hybrid and
dihedral style table.
...
example dihedral style class2.  Please note
...
- [dihedral_style](dihedral_style.html)
